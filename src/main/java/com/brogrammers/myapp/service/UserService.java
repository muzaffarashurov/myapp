package com.brogrammers.myapp.service;

import com.brogrammers.myapp.repository.User;
import com.brogrammers.myapp.repository.UserRepository;
...
public class UserService {
    ...
    public User create(User user) {
        ...
        if (optionalUser.isPresent()) {
            throw new IllegalStateException("User с таким имейлом уже существует");
        }
